...
describe("mutation authority registry coverage", () => {
    ...
    it("classifies the SCW-P1 successor checkpoint writer as an H1 Human mutation", () => {
        expect(MUTATION_AUTHORITY_REGISTRY["POST api/human/coordination/checkpoints/successor"])
            .toBe("H1_HUMAN");
    });
