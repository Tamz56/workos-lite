        ...
        if (existingArticle) {
            db.prepare(`
                ...
                SET article_title = COALESCE(NULLIF(@article_title, ''), article_title),
                    ...
                    body_markdown = COALESCE(NULLIF(@body_markdown, ''), body_markdown),
                    read_more_markdown = COALESCE(NULLIF(@read_more_markdown, ''), read_more_markdown),
                    faq_markdown = COALESCE(NULLIF(@faq_markdown, ''), faq_markdown),
                    references_markdown = COALESCE(NULLIF(@references_markdown, ''), references_markdown),
                    article_markdown = COALESCE(NULLIF(@article_markdown, ''), article_markdown),
            ...
            `).run({
                ...
                read_more_markdown: pkg.read_more_markdown,
                faq_markdown: pkg.faq_markdown,
                references_markdown: pkg.references_markdown,
