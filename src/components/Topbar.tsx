...
export default function Topbar() {
    ...
    const getTitle = () => {
        if (pathname === "/dashboard") return "WorkOS";
        if (pathname === "/arbor-inbox") return "WorkOS";
        ...
        // Specific Content & Workspace Routes
    ...
    return (
        <header className="sticky top-0 z-30 flex h-16 min-w-0 items-center justify-between border-b border-slate-800 bg-slate-900 text-white backdrop-blur-md px-4 md:px-6 shadow-[0_1px_0_0_rgba(0,0,0,0.03)] transition-theme">
            <div className="flex items-center gap-3 min-w-0">
                ...
                <button
                    ...
                    className="md:hidden p-1.5 rounded-md text-slate-300 hover:text-white hover:bg-slate-800 focus:outline-none flex items-center justify-center flex-shrink-0"
            ...
            <div className="flex min-w-0 shrink-0 items-center gap-3">
                <button
                    ...
                    className="flex min-w-0 items-center gap-2 rounded-lg border border-slate-800 bg-slate-800/60 px-2 py-1.5 text-slate-300 transition-all hover:bg-slate-800 hover:text-white group sm:px-3"
                >
                    ...
                    <div className="hidden items-center gap-1 px-1.5 py-0.5 rounded border border-slate-700 bg-slate-800 text-[10px] font-bold text-slate-300 sm:flex">
