...
export function AstroStrategyPlanningPanel({
  ...
  return (
    <div className="bg-slate-900/70 border border-slate-700 rounded-xl p-5 space-y-4">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-slate-700/80 pb-2.5 gap-2">
        ...
        <div className="text-[10px] text-slate-300 flex items-center gap-1">
          <span>สถานะ:</span>
          <span className="font-mono text-slate-200 font-bold bg-slate-950/70 px-2 py-0.5 rounded border border-slate-700">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="bg-slate-950/70 p-3.5 rounded-xl border border-slate-700 space-y-1.5 flex flex-col justify-between">
          <div className="space-y-1">
            <label className="text-xs font-bold text-slate-200 block">🎯 สิ่งที่ต้องโฟกัสถัดไป (Focus Next)</label>
            <span className="text-[10px] text-slate-300 block leading-tight">เป้าหมายเชิงผลผลิตหลัก หรืองานสำคัญที่สุดชิ้นถัดไป</span>
          </div>
          <textarea
        ...
        <div className="bg-slate-950/70 p-3.5 rounded-xl border border-slate-700 space-y-1.5 flex flex-col justify-between">
          <div className="space-y-1">
            <label className="text-xs font-bold text-slate-200 block">⚡ งานเล็ก ๆ ที่ทำได้ทันที (Next Small Action)</label>
            <span className="text-[10px] text-slate-300 block leading-tight">ปฏิบัติการชิ้นเล็กที่เริ่มได้เร็วเพื่อสร้างแรงส่ง (Momentum)</span>
          </div>
          <textarea
      ...
      {/* Cautious disclaimer */}
      <div className="text-[10px] text-slate-300 leading-relaxed pt-2.5 border-t border-slate-700/40 text-center">
