...
export function AstroStrategyPlanningPanel({
  ...
  return (
    <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5 space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="bg-slate-955/35 p-3.5 rounded-xl border border-slate-850 space-y-1.5 flex flex-col justify-between">
          <div className="space-y-1">
            ...
            <span className="text-[10px] text-slate-400 block leading-tight">เป้าหมายเชิงผลผลิตหลัก หรืองานสำคัญที่สุดชิ้นถัดไป</span>
          </div>
          <textarea
            ...
            rows={2}
            className="w-full bg-slate-950 border border-slate-800 rounded-lg px-3 py-2 mt-2 text-xs text-slate-200 focus:outline-none focus:border-violet-500/50 focus:ring-1 focus:ring-violet-500/30 transition-all resize-none placeholder:text-slate-600"
          />
        </div>
        ...
        <div className="bg-slate-955/35 p-3.5 rounded-xl border border-slate-850 space-y-1.5 flex flex-col justify-between">
          <div className="space-y-1">
            ...
            <span className="text-[10px] text-slate-400 block leading-tight">ลดการเร่งงานส่วนเกิน ผ่อนจังหวะเพื่อฟื้นฟูสภาพพลังงาน</span>
          </div>
          <textarea
            value={localSlowDown}
        ...
        <div className="bg-slate-955/35 p-3.5 rounded-xl border border-slate-850 space-y-1.5 flex flex-col justify-between">
          <div className="space-y-1">
            ...
            <span className="text-[10px] text-slate-400 block leading-tight">ปฏิบัติการชิ้นเล็กที่เริ่มได้เร็วเพื่อสร้างแรงส่ง (Momentum)</span>
          </div>
          <textarea
        ...
        <div className="bg-slate-955/35 p-3.5 rounded-xl border border-slate-850 space-y-1.5 flex flex-col justify-between">
          <div className="space-y-1">
            ...
            <span className="text-[10px] text-slate-400 block leading-tight">หัวข้อหรือประเด็นที่ต้องรอดูรอบเวลาและสถานะสัปดาห์หน้า</span>
          </div>
          <textarea
      ...
      {/* Cautious disclaimer */}
      <div className="text-[10px] text-slate-400 leading-relaxed pt-2.5 border-t border-slate-850/40 text-center">
