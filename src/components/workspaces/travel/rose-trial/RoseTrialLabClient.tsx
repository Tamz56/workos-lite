        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex flex-col items-end gap-1.5 self-start">
            ...
            <button
              ...
              className="mt-1 flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-white/90 dark:bg-neutral-900/90 text-xs font-bold text-neutral-700 dark:text-neutral-300 hover:bg-white dark:hover:bg-neutral-800 border border-rose-200/80 dark:border-rose-900/60 shadow-sm transition-colors"
              title="สลับไปยัง Task Workspace"
            >
